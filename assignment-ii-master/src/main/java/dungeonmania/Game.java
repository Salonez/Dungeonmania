...
public class Game implements Serializable {
    ...
    public Game tick(Direction movementDirection) {
        registerOnce(
            (Runnable & Serializable) () -> player.move(this.getMap(), movementDirection),
            PLAYER_MOVEMENT, "playerMoves");
        tick();
        return this;
    }
    ...
    public Game build(String buildable) throws InvalidActionException {
        ...
        registerOnce((Runnable & Serializable) () -> player.build(buildable, entityFactory),
    ...
    public Game interact(String entityId) throws IllegalArgumentException, InvalidActionException {
        ...
        registerOnce(
            (Runnable & Serializable) () -> ((Interactable) e).interact(player, this),
            PLAYER_MOVEMENT, "playerBuildsItem");
        tick();
        return this;
    }
    ...
    public int tick() {
        ...
        tickCount++;
        map.updateStuckEntities();
        map.updateMindControlledEnemies();
        //take a tick off the duration.
        return tickCount;
    }
