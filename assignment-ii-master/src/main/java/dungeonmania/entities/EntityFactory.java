...
public class EntityFactory implements Serializable {
    ...
    public void spawnZombie(Game game, ZombieToastSpawner spawner) {
        ...
        List<Position> pos = spawner.getCardAdjPos();
        pos = pos
            .stream()
    ...
    public Assassin buildAssassin(Position pos) {
        ...
        double assassinAttack = config.optDouble("assassin_health", Assassin.DEFAULT_HEALTH);
        ...
        return new Assassin(pos, assassinHealth, assassinAttack, assassinBribeAmount,
            assassinBribeRadius, assassinFailRate);
    }
